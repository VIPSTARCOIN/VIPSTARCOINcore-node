...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `VIPSTARCOINcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ VIPSTARCOINcore-node add wallet-service');
      console.log('    $ VIPSTARCOINcore-node add VIPSTARCOIN-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ VIPSTARCOINcore-node remove wallet-service');
      console.log('    $ VIPSTARCOINcore-node remove VIPSTARCOIN-api');
      console.log();
    });
